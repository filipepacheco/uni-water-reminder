...
export default createTheme({
  ...
  tokens: {
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsl(199, 94%, 80%)" },
          20: { value: "hsl(199, 93%, 76%)" },
          40: { value: "hsl(199, 93%, 68%)" },
          60: { value: "hsl(199, 93%, 60%)" },
          80: { value: "hsl(199, 62%, 48%)" },
          90: { value: "hsl(199, 62%, 36%)" },
          100: { value: "hsl(199, 62%, 30%)" },
        },
        secondary: {
